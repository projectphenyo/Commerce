...
const products = [
  ...
  },
  {
    ...
    src: Headphones,
    rating: 4.0,
    miniDescription: "High-quality Sony Bluetooth headphones with long battery life and deep bass.",
  ...
  },
  {
    ...
    src: Iphone12Red,
    rating: 4.7,
    miniDescription: "A total powerhouse with a massive leap in battery life.",
    fullDescription: "Features the most advanced dual-camera system ever on an iPhone, boasting Sensor-shift optical image stabilization. Powered by the A15 Bionic chip for lightning-fast performance and improved power efficiency.",
  },
  {
    id: "8",
    name: "iPhone 12",
    ...
    src: Iphone12Red,
    rating: 4.5,
    miniDescription: "Elevate your speed with 5G and a vibrant OLED display.",
    fullDescription: "The first iPhone to feature Ceramic Shield and 5G speeds. Includes the A14 Bionic chip, MagSafe compatibility for easy charging, and a Super Retina XDR display for incredible color accuracy.",
  },
  {
    id: "9",
    name: "MacBook",
    ...
    src: MacBook,
    rating: 4.5,
    miniDescription: "Thin, light, and incredibly powerful for work and creativity.",
    fullDescription: "Precision-engineered from recycled aluminum, the MacBook offers a stunning Retina display and the industry-leading Magic Keyboard. Whether you're editing video or drafting a proposal, the long-lasting battery and macOS ecosystem keep you productive all day.",
  },
  {
    id: "10",
    name: "Dell ",
  ...
  },
  {
    ...
    src: SumsungNote21,
    rating: 4.5,
    miniDescription:"The ultimate power-user phone with the iconic S-Pen.",
    fullDescription: "A computer in your pocket. Featuring a 6.9-inch Dynamic AMOLED 2X display and a versatile S-Pen with ultra-low latency. Capture pro-grade 8K video and enjoy a seamless work-from-anywhere experience.",
  },
  {
    id: "16",
    ...
    rating: 4.0,
    miniDescription: "The ultimate iPhone experience with the largest display.",
    fullDescription: "For those who want it all. A massive 6.7-inch display, professional triple-camera array, and the longest battery life in the 13-series lineup. Finished in a sleek, premium Jet Black glass.",
  },
  {
    id: "17",
